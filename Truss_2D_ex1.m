...
%%%%%%% 2.2. nodal conectivity for elements = matriz de conectividade
...
force = zeros(nDof,1);
%lembrar que ele convenciona os vetores como [x1 x2 x3 y1 y2 y3], portanto
%a força será nos Dof 2 e 5
...
% 
% %%%%%%%% Now, we need to import ANSYS results
...
%adaptei para não contar os dados do Ansys.
figure
plot(xy(:,1),xy(:,2),'k:','LineWidth',2);
hold on
...
grid on
view(2)
legend('Undeformed shape', 'Deformed shape - FEA code')
legend('boxoff')
set(gca,'FontSize',16);
